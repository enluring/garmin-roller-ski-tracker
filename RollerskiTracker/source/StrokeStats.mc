...
class StrokeStats {
    ...
    // Resets all totals. Call on DataField.onTimerReset() (new session).
    ...
    // Call when a new lap begins (e.g. from DataField.onTimerLap()), passing
    // the elapsed session distance at the lap boundary.
